...
public class SortFields {
    ...
    public enum sortingFields {
        AVERAGE_RATE, BOWLER_AVERAGE_RATE,STRIKE_RATE,BOWLER_STRIKE_RATE, FOUR_SIX_RATE, FOUR_SIX_STRIKE_RATE, AVERAGE_STRIKE_RATE, BOWLER_AVERAGE_STRIKE_RATE,RUNS_AVERAGE_RATE, ECONOMY_RATE , FOUR_WICKETS_AND_FIVE_WICKETS, FOUR_WICKETS_AND_FIVE_WICKETS_STRIKE, BOWLER_FOUR_WICKETS_AND_FIVE_WICKETS_STRIKE, AVERAGE_WICKET_RATE;
    }
    ...
    public Comparator getFieldCricketer(sortingFields sortingFields) {
        ...
        Comparator<CricketAnalyzerDAO> codeAvgComparator = (data1, data2) -> ((data1.average < data2.average)? -1 : 1);
        ...
        Comparator<CricketAnalyzerDAO> bowlStrikeRate = (data1 , data2) -> (int)((data1.bowlStrikeRate - data2.bowlStrikeRate));
        compareBatsmanHashMap.put(SortFields.sortingFields.BOWLER_STRIKE_RATE,bowlStrikeRate);

        Comparator<CricketAnalyzerDAO> bowlAverageRate = (data1 , data2) -> (int)((data1.bowlAverage - data2.bowlAverage));
        ...
        compareBatsmanHashMap.put(SortFields.sortingFields.FOUR_WICKETS_AND_FIVE_WICKETS,(data1, data2)->((data2.fourWickets*4 + data2.fiveWickets*5) - (data1.fourWickets*4 + data1.fiveWickets*5)));
